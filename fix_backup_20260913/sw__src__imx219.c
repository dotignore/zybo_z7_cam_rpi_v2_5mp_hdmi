...
int Imx219_Config1080pRaw10(void)
{
	...
	if (WriteTableNamed("Frame timing -> FL=1763 LL=3448 (~30 fps)",
			    Imx219CfgTiming,
	...
	xil_printf("[IMX219] frame_len=1763 line_len=3448  lanes=2  CSI_FMT=0x0A0A\r\n");
	return XST_SUCCESS;
}
