 ...
 * FRM_LENGTH=1763, LINE_LENGTH=3448 — working values from bring-up logs.
 * Datasheet: max 60 fps @1080p V-crop (p.1); LINE_LENGTH default 3448 (p.30).
 */
...
static const Imx219Reg Imx219CfgTiming[] = {
	{0x0160, 0x06}, /* FRM_LENGTH = 1763 */
	{0x0161, 0xE3},
	{0x0162, 0x0D}, /* LINE_LENGTH = 3448 */
	{0x0163, 0x78},
};
