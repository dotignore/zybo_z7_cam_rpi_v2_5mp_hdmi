...
HD_PWD='C:/github/zybo_z7_cam_rpi_v2_5mp_hdmi/zybo_z7_imx219/zybo_z7_imx219.runs/design_1_axis_raw_to_gbr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_raw_to_gbr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_raw_to_gbr_0_0.tcl
