...
HD_PWD='V:/zybo_z7_imx219/zybo_z7_imx219.runs/design_1_capture_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_capture_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_capture_fifo_0.tcl
