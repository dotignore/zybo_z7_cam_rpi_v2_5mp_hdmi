...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_video_TREADY { I 1 bit } m_axis_video_TDATA { O 30 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln240 \
    op interface \
    ports { add_ln240 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgUnzip_dout { I 30 vector } imgUnzip_empty_n { I 1 bit } imgUnzip_read { O 1 bit } imgUnzip_num_data_valid { I 3 vector } imgUnzip_fifo_cap { I 3 vector } } \
} "
}
